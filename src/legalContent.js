    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'Les présentes conditions générales de vente (« CGV ») régissent la fourniture par LARPILOTE de services de gestion virtuelle et de pilotage opérationnel à distance des locations courte durée, aux propriétaires et aux conciergeries qui y souscrivent (le « Client »).',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'La souscription s’effectue à l’issue d’un échange entre le Client et LARPILOTE permettant de présenter l’activité du Client, d’analyser ses besoins et de configurer les procédures, accès et contacts nécessaires à l’exécution du service, conformément au déroulé présenté sur la page Comment ça marche.',
          },
        ],
      },
      {
        heading: '4. Tarifs et facturation',
        blocks: [
          {
            type: 'p',
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'Sauf accord contraire, les services sont souscrits pour une durée déterminée avec reconduction, dans les conditions précisées au Client lors de la souscription. Chaque partie peut résilier dans les conditions et délais qui seront précisés dans le contrat conclu avec le Client. Le Client peut à tout moment changer de formule, sous réserve des conditions prévues à son contrat.',
          },
        ],
      },
      {
        heading: '6. Obligations de LARPILOTE',
        blocks: [
          {
            type: 'p',
            text: 'LARPILOTE s’engage à exécuter les tâches prévues par la formule souscrite avec diligence et selon les procédures définies avec le Client. LARPILOTE agit dans le cadre d’une obligation de moyens : elle ne garantit aucun taux d’occupation, nombre de réservations ou chiffre d’affaires.',
          },
        ],
      },
      {
        heading: '7. Obligations du Client',
        blocks: [
          {
            type: 'p',
            text: 'Le Client s’engage à fournir à LARPILOTE les informations, accès et instructions nécessaires à l’exécution du service, à désigner les prestataires et personnes de confiance pertinents, et à conserver la gestion physique de son ou ses logements ainsi que la responsabilité des équipes et prestataires locaux.',
          },
        ],
      },
      {
        heading: '8. Incidents et interventions physiques',
        blocks: [
          {
            type: 'p',
            text: 'En cas d’incident signalé par un voyageur, LARPILOTE analyse la situation et contacte le prestataire désigné par le Client, puis assure le suivi jusqu’à résolution. Les interventions physiques, leurs coûts, délais et garanties restent sous la seule responsabilité du Client, de la conciergerie ou du prestataire concerné.',
          },
        ],
      },
      {
        heading: '9. Propriété des comptes et des données',
        blocks: [
          {
            type: 'p',
            text: 'Le Client conserve à tout moment la propriété de ses comptes Airbnb, Booking et autres plateformes, ainsi que de ses revenus. LARPILOTE intervient dans le cadre des accès et autorisations que le Client lui accorde et ne se substitue jamais à lui dans la propriété de ses comptes.',
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'Le traitement des données personnelles dans le cadre de l’exécution des services est décrit dans notre Politique de confidentialité.',
          },
        ],
      },
      {
        heading: '11. Modification des CGV',
        blocks: [
          {
            type: 'p',
            text: 'LARPILOTE peut modifier les présentes CGV. Les CGV applicables sont celles en vigueur à la date de souscription ou de reconduction du contrat.',
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'Un cookie est un petit fichier texte déposé sur votre appareil lors de la consultation d’un site internet. Il permet notamment de faire fonctionner certaines fonctionnalités du site ou de mesurer sa fréquentation.',
          },
        ],
      },
      {
        heading: '2. Cookies utilisés sur larpilote.com',
        blocks: [
          {
            type: 'p',
            text: 'À ce jour, larpilote.com n’utilise aucun cookie publicitaire ni outil de mesure d’audience. Le Site peut recourir à des cookies strictement nécessaires à son fonctionnement technique (par exemple pour mémoriser certaines préférences d’affichage). Ces cookies ne nécessitent pas de consentement préalable au regard de la réglementation applicable.',
          },
        ],
      },
      {
        heading: '3. Polices et ressources tierces',
        blocks: [
          {
            type: 'p',
            text: 'Le Site charge des polices de caractères hébergées par Google Fonts. Ce chargement peut entraîner un appel technique vers les serveurs de Google, sans dépôt de cookie de suivi dans le cadre normal d’utilisation de ce service.',
          },
        ],
      },
      {
        heading: '4. Évolution à venir',
        blocks: [
          {
            type: 'p',
            text: 'LARPILOTE pourra, à l’avenir, mettre en place des outils de mesure d’audience afin d’améliorer le Site. Le cas échéant, cette politique sera mise à jour et un bandeau de consentement adapté sera proposé aux visiteurs, conformément à la réglementation applicable.',
          },
        ],
      },
      {
        ...
        blocks: [
          {
            type: 'p',
            text: 'Vous pouvez à tout moment configurer votre navigateur pour accepter, refuser ou être informé du dépôt de cookies. Les modalités varient selon les navigateurs et sont généralement accessibles depuis les paramètres de confidentialité de celui-ci.',
          },
        ],
      },
      {
